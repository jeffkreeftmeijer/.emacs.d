...
#+include: "emacs-general-configuration.org" :lines "3-" :only-contents t
...
#+include: "emacs-straight-use-package.org" :lines "10-" :only-contents t
...
:END:
   #+include: "emacs-evil-org-tab.org" :lines "10-" :only-contents t
