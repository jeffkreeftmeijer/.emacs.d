...
Enable [[https://www.gnu.org/software/emacs/manual/html_node/emacs/Saving-Emacs-Sessions.html#Saving-Emacs-Sessions][~desktop-save-mode~]] to save Emacs' state between sessions.

#+headers: :noweb-ref desktop-config
#+begin_src emacs-lisp
  (desktop-save-mode 1)
#+end_src
