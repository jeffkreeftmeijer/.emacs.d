:PROPERTIES:
:ID:       717C84DE-62C3-4E10-98C6-B4C3390F3B81
:END:
#+title: Emacs package management with straight.el and use-package
#+author: Jeff Kreeftmeijer
#+html_path: /emacs-straight-use-package/
#+date: 2021-08-16
...
[[https://github.com/raxod502/straight.el][Straight.el]] is an alternative package manager that installs packages through Git checkouts instead of downloading tarballs from one of the package archives.
...
The [[https://github.com/raxod502/straight.el#getting-started][Getting started]] section in the straight.el README provides the bootstrap code to place inside =~/.emacs.d/init.el= in order to install it:
...
- =:config= and =:init= ::
  ...
  To [[id:37FA1876-075E-43DA-B402-8DA102705FD6][turn off =evil-want-C-i-jump=]] right before evil is loaded (instead of adding it to the early init file), configure it in the =:init= keyword:
